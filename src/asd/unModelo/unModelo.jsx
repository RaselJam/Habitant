    ...
    <div className={style.unModelo}>
      <div className={style.container}>
        ...
        <div className={style.right}>
          ...
          <ul>
            <li>
              <div>{tickSVG}</div><div>Un único proveedor, todos los servicios.</div>
            </li>
            <li>
              <div>{tickSVG}</div><div>Posibilidad de convivencia con tus actuales
              estrategias de tráfico y adquisición.</div> 
            </li>
            <li>
              <div>{tickSVG}</div><div>Paga solamente por los objetivos
              conseguidos.</div>
            </li>
          </ul>
          <div className={style.links}>
            <div>Ver todas las ventajas {GetSVG({name:"pathDown", color : "#ffffff"})}</div>
            <div>¿Hablamos? {GetSVG({name:"pathDown", color : "#ffffff"})}</div>
          </div>
        </div>
      </div>
    </div>
